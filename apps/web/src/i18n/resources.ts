  ...
  workspace: {
    ...
    management: {
      ...
      virtualMachines: {
        ...
        createIsoPath: "ISO path",
        createIsoPathHint: "The file must be inside a configured ISO root, usually /srv/iso.",
  ...
  workspace: {
    ...
    management: {
      ...
      virtualMachines: {
        ...
        createIsoPath: "ISO 路径",
        createIsoPathHint: "文件必须位于配置的 ISO 根目录中，通常是 /srv/iso。",
