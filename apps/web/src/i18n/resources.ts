  ...
  workspace: {
    ...
    management: {
      ...
      virtualMachines: {
        ...
        create: "Create VM",
        createDescription: "Configure a guest, choose its boot media, and send the request for approval.",
        ...
        createApprovalTitle: "Approval required",
        createApprovalDetail: "SigmaOS will create an approval request. No VM or disk is changed until it is approved.",
  ...
  workspace: {
    ...
    management: {
      ...
      virtualMachines: {
        ...
        hypervisor: "libvirt / QEMU",
        create: "创建虚拟机",
        createDescription: "配置客户机、选择启动介质，并提交审批请求。",
        createIdentity: "身份信息",
        ...
        createNetworks: "个网络",
        createApprovalTitle: "需要审批",
        createApprovalDetail: "SigmaOS 会创建审批请求；审批通过前不会创建虚拟机或修改磁盘。",
